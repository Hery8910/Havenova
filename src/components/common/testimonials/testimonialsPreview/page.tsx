...
export interface TestimonialsPreviewItems {
  text: string;
  author: string;
  profileImage: {
    src: string;
...
export interface TestimonialsPreviewData {
  title: string;
  subTitle: string;
  description: string;
  items: TestimonialsPreviewItems[];
...
const TestimonialsPreview = () => {
  ...
  const testimonials: TestimonialsPreviewData = texts?.pages?.home?.testimonials;
  if (!testimonials) {
    return (
