...
import BlogInfo from "../blogInfo/page";
...
import BlogTableSkeleton from "../blogTableSkeleton/page";
                  ...
                  {blogs.map((blog) => (
                    ...
                    >
                      ...
                      <p className={styles.p}>
                        ...
                        {blog.comments
                          ? `(${blog.comments.filter((comment) => !comment.approved).length}) unread`
                          : "0"}
                      </p>
