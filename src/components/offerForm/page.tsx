...
import Input from "../blog/input/page";
import Info from "../info/page";
import { validateTitle } from "../../utils/validators";
import Select from "../select/page";
import SelectDashboard from "../selectDashboard/page";
            ...
            <div className={styles.header_div}>
              ...
              <Info
                ...
                info={{
                  ...
                  answer:
                    "It will be shown as the main headline for your offer.",
                }}
              />
            </div>
            <Input
            ...
            <div className={styles.header_div}>
              ...
              <Info
                ...
                info={{
                  ...
                  answer:
                    "Detailed information displayed when users click to read more.",
                }}
              />
            </div>
            <Input
        ...
        <article className={styles.article}>
          ...
          <Info
            ...
            info={{
              ...
              answer:
                "Defines the logic for when and how the offer is applied.",
            }}
          />
        </article>
        ...
        <article className={styles.article}>
          ...
          <Info
            ...
            info={{
              ...
              answer:
                "The page where the user will be redirected after clicking the CTA.",
            }}
          />
        </article>
