...
const ResetPassword = () => {
  ...
  const resetPasswordText: ResetPasswordData =
    texts?.pages?.user.resetPasswordText;
    ...
    try {
      ...
      if (!formData.password) {
        setAlert({
          type: "error",
          title:
            popups.USER_EDIT_EMPTY_NEW_PASSWORD.title ||
      ...
      if (response.success) {
        ...
        setAlert({
          ...
          description:
            ...
            popups.USER_EDIT_USER_UPDATE_SUCCESS.description,
        });
        setTimeout(() => {
          setAlert(null);
          router.push("/");
      ...
      if (error.response && error.response.data) {
        ...
        setAlert({
          ...
          title:
            popupData.title ||
            popups.GLOBAL_INTERNAL_ERROR.title ||
            "Unerwarteter Fehler.",
          description:
            popupData.description ||
