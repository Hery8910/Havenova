...
export type PageMetadata = {
  ...
  export const aboutMetadata: PageMetadata = {
    ...
    description: "Learn more about Havenova, our mission, and the team dedicated to delivering top-quality handyman services in Berlin.",
    ...
    openGraph: {
      ...
      description: "Discover who we are and why customers trust Havenova for home maintenance services in Berlin.",
      type: "website",
  ...
  export const servicesMetadata: PageMetadata = {
    ...
    description: "Explore all Havenova services in Berlin, including furniture assembly, kitchen installation, home cleaning, and more.",
    keywords: "services Berlin, handyman services, furniture assembly, home maintenance Berlin, cleaning services",
    openGraph: {
  ...
  export const furnitureAssemblyMetadata: PageMetadata = {
    ...
    description: "Professional furniture assembly services in Berlin. Book with Havenova for reliable, precise, and efficient assembly.",
    ...
    openGraph: {
      ...
      description: "Get expert furniture assembly services in Berlin with Havenova. Trusted by homeowners and businesses.",
      type: "website",
  ...
  export const kitchenAssemblyMetadata: PageMetadata = {
    ...
    description: "Expert kitchen assembly services in Berlin. Book now with Havenova for professional and precise installations.",
    keywords: "kitchen assembly Berlin, kitchen installation, handyman services Berlin, professional assembly",
    openGraph: {
      title: "Kitchen Assembly in Berlin - Havenova",
      description: "Book professional kitchen assembly services in Berlin with Havenova and enjoy hassle-free installations.",
      type: "website",
  ...
  export const homeServiceMetadata: PageMetadata = {
    ...
    description: "Reliable home services in Berlin. Book Havenova for maintenance, repairs, and household support.",
    ...
    openGraph: {
      ...
      description: "Discover reliable home services and maintenance solutions in Berlin with Havenova.",
      type: "website",
  ...
  export const houseCleaningMetadata: PageMetadata = {
    ...
    description: "Professional house cleaning services in Berlin. Book with Havenova for thorough and reliable cleaning.",
    keywords: "house cleaning Berlin, professional cleaning, Berlin cleaning services, thorough home cleaning",
    openGraph: {
      title: "House Cleaning in Berlin - Havenova",
      description: "Book reliable house cleaning services in Berlin with Havenova for spotless results.",
      type: "website",
  ...
  export const kitchenCleaningMetadata: PageMetadata = {
    ...
    description: "Professional window cleaning services in Berlin. Book with Havenova for crystal-clear windows.",
    keywords: "window cleaning Berlin, professional window cleaning, glass cleaning services, Berlin handyman",
    openGraph: {
      title: "Windows Cleaning in Berlin - Havenova",
      description: "Get professional window cleaning services in Berlin with Havenova for spotless, streak-free windows.",
      type: "website",
  ...
  export const contactMetadata: PageMetadata = {
    ...
    description: "Get in touch with Havenova for reliable and fast handyman services in Berlin. We’re ready to assist with any home project.",
  ...
  export const blogMetadata: PageMetadata = {
    ...
    description: "Read helpful articles and insights from Havenova’s team of professionals on home maintenance and handyman services in Berlin.",
    keywords: "handyman blog Berlin, home maintenance tips, service advice, cleaning guides, furniture assembly tips",
    openGraph: {
  ...
  export const faqMetadata: PageMetadata = {
    ...
    description: "Find answers to common questions about our handyman services, booking process, payments, and more.",
    ...
    openGraph: {
      ...
      description: "Explore frequently asked questions and answers about Havenova’s services in Berlin.",
      type: "website",
  ...
  export const reviewsMetadata: PageMetadata = {
    ...
    description: "Read real customer reviews for Havenova. Trusted home services provider in Berlin with excellent feedback.",
    ...
    openGraph: {
      ...
      description: "See what customers are saying about Havenova’s services and why they recommend us.",
      type: "website",
  ...
  export const privacyPolicyMetadata: PageMetadata = {
    ...
    description: "Read Havenova’s privacy policy to understand how we protect and use your personal data.",
  ...
  export const termsOfServiceMetadata: PageMetadata = {
    ...
    description: "Review Havenova’s terms of service for all professional handyman and home maintenance services in Berlin.",
  ...
  export const cookiePolicyMetadata: PageMetadata = {
    ...
    openGraph: {
      ...
      description: "Read our cookie policy and understand how cookies are used on the Havenova website.",
      type: "website",
