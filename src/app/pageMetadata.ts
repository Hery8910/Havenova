...
export const homeMetadata: PageMetadata = {
  ...
  openGraph: {
    ...
    description:
      "Book expert handyman services today and get a 10% discount on your first order.",
    type: "website",
...
export const servicesMetadata: PageMetadata = {
  ...
  openGraph: {
    ...
    description:
      "Discover our range of handyman services in Berlin tailored to your home needs.",
    type: "website",
...
export const furnitureAssemblyMetadata: PageMetadata = {
  ...
  keywords:
    "furniture assembly Berlin, handyman services, furniture setup, assembly service",
  openGraph: {
...
export const homeServiceMetadata: PageMetadata = {
  ...
  keywords:
    "home services Berlin, maintenance services, handyman repairs, Berlin home support",
  openGraph: {
...
export const contactMetadata: PageMetadata = {
  ...
  keywords:
    "contact Havenova, handyman Berlin, home service inquiries, get in touch",
  openGraph: {
    title: "Contact Havenova - Your Home Service Partner in Berlin",
    description:
      "Reach out to our team for expert assistance with home repairs and maintenance.",
    type: "website",
...
export const blogMetadata: PageMetadata = {
  ...
  openGraph: {
    ...
    description:
      "Stay informed with expert articles on home improvement and handyman services.",
    type: "website",
...
export const faqMetadata: PageMetadata = {
  ...
  keywords:
    "FAQ Havenova, handyman questions, service information, booking guide, payment info",
  openGraph: {
...
export const reviewsMetadata: PageMetadata = {
  ...
  keywords:
    "Havenova reviews, customer feedback, testimonials, Berlin home services",
  openGraph: {
...
export const privacyPolicyMetadata: PageMetadata = {
  ...
  keywords:
    "privacy policy Havenova, data protection, user privacy, Berlin services",
  openGraph: {
...
export const termsOfServiceMetadata: PageMetadata = {
  ...
  keywords:
    "terms of service Havenova, service terms, user agreement, Berlin home services",
  openGraph: {
    title: "Terms of Service - Havenova Home Services",
    description:
      "Understand the terms and conditions of using Havenova’s services in Berlin.",
    type: "website",
...
export const cookiePolicyMetadata: PageMetadata = {
  ...
  description:
    "Learn how Havenova uses cookies to enhance user experience on our website.",
  keywords:
    "cookie policy Havenova, cookies use, website tracking, Berlin home services",
  openGraph: {
