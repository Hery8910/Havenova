...
const CheckOut = () => {
  const blogs = [
    {
      id: '1',
      title: 'How to Choose the Best Maintenance Service for Your Home and Avoid Scams',
          ...
          content: [
            {
              ...
              paragraph: 'Low prices can mean poor quality work or hidden costs.',
            },
          ],
        },
      ],
      faq: [
        {
          ...
          answer: 'Most experts recommend at least once a year for general inspections.',
        },
      ],
    ...
    },
    {
      ...
      sections: [
        ...
        },
        {
          ...
          content: [
            {
              paragraph: 'Knowing your home is in good condition brings comfort and security.',
            },
          ],
        },
      ],
