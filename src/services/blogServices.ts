...
export const createBlog = async (blog: BlogPost, clientId: string, status: string): Promise<void> => {
...
export  const updateBlog = async (blog: BlogPost, blogId: string, clientId: string, status: string): Promise<void> => {
